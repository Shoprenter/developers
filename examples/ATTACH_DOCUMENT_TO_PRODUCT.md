...
A [File resource](https://www.shoprenter.hu/api/doc#file) segítségével töltsük fel a kívánt dokumentumot pl: egy képet. Fontos, hogy a request során megadott **filePath** ban adjuk meg a **srattached\/** mappát, illetve a **type** mindenképp az **image** legyen.

Példa request:

Method: **POST**

Url: **http://shopname.api.shoprenter.hu/files**
...
Ezt követően az előbb feltöltött képhez a [Document resource](https://www.shoprenter.hu/api/doc#document) segítségével egy azonosítót hozunk létre, amit legkönnyebben az alábbi request elküldésével tudjuk megkapni.

Példa request:

Method: **POST**

Url: **http://shopname.api.shoprenter.hu/documents**
...
Url: **http://shopname.api.shoprenter.hu/documentDescriptions**
...
Url: **http://shopname.api.shoprenter.hu/productDocumentRelations**
